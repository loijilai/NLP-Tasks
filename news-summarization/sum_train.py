...
def parse_args():
    ...
    output_dir = "/tmp2/loijilai/adl/NLP-Tasks/news-summarization/outputs"
    train_file = "/project/dsp/loijilai/adl/dataset2/train.jsonl"
    resume_from_checkpoint = "/tmp2/loijilai/adl/NLP-Tasks/news-summarization/outputs/epoch_14"
    text_column = None
    summary_column = None
    ...
    parser.add_argument(
        "--num_warmup_steps", type=int, default=num_warmup_steps, help="Number of steps for the warmup in the lr scheduler."
    )
...
def main():
    ...
    column_names = raw_datasets["train"].column_names # ['date_publish', 'title', 'source_domain', 'maintext', 'split', 'id']
    ...
    for epoch in range(starting_epoch, args.num_train_epochs):
        ...
        if args.with_tracking:
            ...
            with open(os.path.join(args.output_dir, "results.json"), "a+") as writer:
